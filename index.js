	...
	if (message.content.startsWith(prefix)){
		switch(args[0]){
			...
			case 'ence':
				...
				.attachFiles(['./assets/ence/logo/logo.png'])
				.setThumbnail('attachment://logo.png')
				.setFooter('Reply with an exclamation mark(!) prefixing every command.\nCommands are case sensitive.')
				.setColor(0xF1C40F);
			...
			case 'faze':
				...
				.attachFiles(['./assets/fazeclan/logo/logo.png'])
				.setThumbnail('attachment://logo.png')
				.setFooter('Reply with an exclamation mark(!) prefixing every command.\nCommands are case sensitive.')
				.setColor(0xF1C40F);
			...
			case 'fnc':
				...
				.attachFiles(['./assets/fnatic/logo/logo.png'])
				.setThumbnail('attachment://logo.png')
				.setFooter('Reply with an exclamation mark(!) prefixing every command.\nCommands are case sensitive.')
				.setColor(0xF1C40F);
			...
			case 'g2':
				...
				.attachFiles(['./assets/g2/logo/logo.png'])
				.setThumbnail('attachment://logo.png')
				.setFooter('Reply with an exclamation mark(!) prefixing every command.\nCommands are case sensitive.')
				.setColor(0xF1C40F);
			...
			case 'msp':
				...
				.attachFiles(['./assets/mousesports/logo/logo.png'])
				.setThumbnail('attachment://logo.png')
				.setFooter('Reply with an exclamation mark(!) prefixing every command.\nCommands are case sensitive.')
				.setColor(0xF1C40F);
			...
			case 'navi':
				...
				.attachFiles(['./assets/navi/logo/logo.png'])
				.setThumbnail('attachment://logo.png')
			...
			case 'nip':
				...
				.attachFiles(['./assets/nip/logo/logo.png'])
				.setThumbnail('attachment://logo.png')
			...
			case 'liqd':
				...
				.attachFiles(['./assets/liquid/logo/logo.png'])
				.setThumbnail('attachment://logo.png')
